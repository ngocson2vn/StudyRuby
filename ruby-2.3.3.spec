...
BuildRequires:  readline libyaml libyaml-devel readline-devel ncurses ncurses-devel gdbm gdbm-devel glibc-devel tcl-devel gcc unzip openssl-devel libdb-devel byacc make libffi-devel
Requires:       libyaml openssl
#Source0:        ftp://ftp.ruby-lang.org/pub/ruby/ruby-%{rubyver}-%{rubyminorver}.tar.gz
Source0:        http://cache.ruby-lang.org/pub/ruby/2.3/ruby-%{rubyver}.tar.gz
...
%changelog
* Sun Dec 11 2016 Son Nguyen <ngocson2vn@gmail.com> - 2.3.3
- Latest Ruby
...
* Fri Feb 24 2012 Ian Meyer <ianmmeyer@gmail.com> - 1.9.3-p125-1
